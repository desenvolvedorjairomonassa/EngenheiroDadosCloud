...
rais = (
    ...
    .option("delimiter", ";")
    .load("s3://modulo1-11be0fb9b134642f8bfc165a5194c3d5/microdados_vinculos.csv")
)
...
(
    ...
    .format("parquet")
    .partitionBy("year")
    .save("s3://modulo1-11be0fb9b134642f8bfc165a5194c3d5/staging")
)
...
(
    ...
    .partitionBy('ano', 'uf')
    .format('parquet')
    .save('s3://modulo1-11be0fb9b134642f8bfc165a5194c3d5/rais/')
)
